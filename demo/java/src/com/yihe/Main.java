...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            Class<?> classType = Class.forName("com.yihe.Main");
        ...
        try {
            List<Class> list=getClassesByPackageName("com.yihe");
...
//        // 包下面的类
//        Set<Class<?>> clazzs = getClasses("com.yihe.reflect");
//        if (clazzs == null) {
//            return;
//        }
//
...
//        try {
//            Class<?> classType = Class.forName("com.yihe.reflect");
//            if (classType == null) {
//                throw new Exception("adf");
//            }
//            Class<?> cls3 = Class.forName("com.yihe.ReflectTest01", false, null);
...
//        boolean bload = false;
//        try {
//            Thread.currentThread().getContextClassLoader().loadClass("com.yihe.ReflectTest01");
//            bload = true;
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
